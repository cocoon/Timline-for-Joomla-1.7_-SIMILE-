...
*/
    ...
    global $pages_in_list, $Itemid, $limitstart, $limit, $total, $pages_in_list;
        ...
        if ($this_page > 1) {
            ...
            echo "\n<a href=\"index.php?option=com_timeline&amp;task=data&amp;Itemid=$Itemid&amp;limitstart=0\" title=\"". _SM_FIRST_PAGE ."\"><<</a>";
            echo "\n<a href=\"index.php?option=com_timeline&amp;task=data&amp;Itemid=$Itemid&amp;limitstart=$page\" title=\"". _SM_PREV_PAGE ."\"><</a>";
        }
      	...
      	for ($i=$start_loop; $i <= $stop_loop; $i++) {
      		...
      		if ($i == $this_page) {
      			...
      			echo "\n<a class=\"pagenav\" href=\"index.php?option=com_timeline&amp;task=data&amp;Itemid=$Itemid&amp;limitstart=$page\"><strong>$i</strong></a>";
      		}
      	}
        ...
        if ($this_page < $total_pages) {
            ...
            echo "\n<a href=\"index.php?option=com_timeline&amp;task=data&amp;Itemid=$Itemid&amp;limitstart=$page\" title=\"". _SM_NEXT_PAGE ."\">></a>";
            echo "\n<a href=\"index.php?option=com_timeline&amp;task=data&amp;Itemid=$Itemid&amp;limitstart=$end_page\" title=\"". _SM_LAST_PAGE ."\">>></a>";
        }
    }
